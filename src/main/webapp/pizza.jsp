...
<form method="POST" action="pizza-order">
    <p>Enter name for the order</p>
    <input type ="text" name="username" placeholder="Enter your name">
    <br>
    <p>Enter the address for closest pickup or delivery</p>
    ...
    <br>
    <h1>Sauce Choices</h1>
<p> Please choose one sauce for the base of your pizza.</p>
    <hr>
    <label for="marinara">Marinara Sauce</label>
    <input id="marinara" type="radio" name="sauce" value="Marinara"><br>
    <label for="alfredo">Alfredo Sauce</label>
    <input id="alfredo" type="radio" name="sauce" value="Alfredo"><br>
    <label for="oil">Olive Oil/No Sauce</label>
    <input id="oil" type="radio" name="sauce" value="Oil"><br>
<br>
<p> How much sauce would you like?</p>
<label for="light-sauce">Light Sauce</label>
<input id="light-sauce" type="radio" name="sauce-amount" value="light"><br>
<label for="regular-sauce">Regular Sauce</label>
<input id="regular-sauce" type="radio" name="sauce-amount" value="regular"><br>
<label for="more-sauce">More Sauce</label>
<input id="more-sauce" type="radio" name="sauce-amount" value="more"><br>
    <br>

    <h1> Crust Size </h1>
<hr>
<label for="small">Small</label>
<input id="small" type="radio" name="size" value="small"><br>
<label for="medium">Medium</label>
<input id="medium" type="radio" name="size" value="medium"><br>
<label for="large">Large</label>
<input id="large" type="radio" name="size" value="large"><br>
<br>
